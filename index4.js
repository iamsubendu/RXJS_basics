...
import { catchError, pluck, map, filter } from 'rxjs/operators';
...
const observable = new Observable((subscriber) => {
  ...
  // The pluck operator in RxJS was deprecated because it had some
  // limitations and was not as versatile as newer operators
  // introduced in RxJS.Specifically, pluck only allowed you to
  // extract a single property from each emitted object in the
  // observable sequence.
  pluck('data'),
